    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="prose prose-stone max-w-none">
          ...
          <p>
            All products sold on our website are intended for legal use in accordance with local, state, and federal laws. We reserve the right to discontinue any product at any time. Product descriptions and images are for informational purposes only and actual products may vary slightly from their descriptions.
          </p>
          <p className="mt-2">
            Cleveland Cartridge Co. makes no guarantees about the legality of our products in your jurisdiction. It is your responsibility to ensure compliance with all applicable laws before making a purchase.
          </p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">10. Severability</h2>
          <p>
