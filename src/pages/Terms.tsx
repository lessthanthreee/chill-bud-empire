      ...
      <div className="container mx-auto px-4 py-12 pt-24">
        <div className="max-w-3xl mx-auto bg-card p-8 rounded-lg shadow-sm">
          ...
          <div className="prose prose-stone max-w-none">
            ...
            <p>
              You must be 21 years of age or older to purchase products from our website. By using this website and/or placing an order, you confirm that you are at least 21 years old. We reserve the right to request proof of age at any point and may cancel orders if adequate proof is not provided.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">3. Products and Delta-8 THC Legal Disclaimer</h2>
            <p>
              All products sold on our website are intended for legal use in accordance with local, state, and federal laws. Our products contain delta-8 THC, which is a cannabinoid derived from hemp. The 2018 Farm Bill legalized hemp and hemp derivatives at the federal level, but delta-8 THC's legal status varies by state.
            </p>
            <p className="mt-2">
              It is your responsibility to determine whether delta-8 THC is legal in your jurisdiction before making a purchase. Cleveland Cartridge Co. makes no guarantees about the legality of our products in your jurisdiction and will not be held responsible for any legal issues that arise from purchasing or using our products where delta-8 THC is restricted or prohibited.
            </p>
            <p className="mt-2">
              Our products may cause intoxication and impairment. Do not drive or operate heavy machinery while using our products. Keep out of reach of children and pets.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">4. Orders and Payment</h2>
            <p>
              All orders are subject to acceptance and availability. We reserve the right to refuse any order for any reason at our sole discretion. Payment for all orders must be made in full at the time of purchase. We currently accept cryptocurrency payments as specified on our payment page.
            </p>
            <p className="mt-2">
            ...
            <p>
              We will make every effort to deliver products within the estimated timeframes indicated at checkout. However, we cannot guarantee specific delivery times and are not responsible for delays beyond our control, including but not limited to carrier delays, weather conditions, or other force majeure events.
            </p>
            <p className="mt-2">
              Please refer to our <a href="/shipping" className="text-primary hover:underline">Shipping Policy</a> for detailed information on shipping methods, costs, and estimated delivery times.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">6. Returns and Refunds</h2>
            <p>
              We accept returns within 14 days of delivery for unopened and undamaged products. To initiate a return, please contact our customer service team. Refunds will be processed using the original payment method, excluding shipping costs.
            </p>
            <p className="mt-2">
